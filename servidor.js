...
app.post('/gerar-pix', async (req, res) => {
    ...
    try {
        ...
        console.log("✅ PIX gerado no Mercado Pago com sucesso!");
        res.json({ qr_code_copia_cola: resultado.point_of_interaction.transaction_data.qr_code });
...
// 3. Adaptador de Nuvem: Usa a porta da nuvem ou a 3001 no seu PC
